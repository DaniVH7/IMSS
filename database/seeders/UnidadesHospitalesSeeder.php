...
use App\Models\UnidadHospital;
use Illuminate\Database\Seeder;
use Illuminate\Database\Console\Seeds\WithoutModelEvents;
use File;

class UnidadesHospitalesSeeder extends Seeder
{
    /**
    ...
    {
        $json = File::get('database/data/unidades_hospitales.json');

        $unidades_hospitales = json_decode($json);

        foreach($unidades_hospitales as $key => $value) {
            UnidadHospital::create([
